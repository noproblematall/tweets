! function (e) {
    ...
    154: function (e, t, n) {
        ...
        var r = 1,
            ...
            s = "",
            u = 20,
            l = [0, 200, 680, 1260, 1635, 2035, 2495, 2895, 3245, 3445, 3795, 5095, 5505],
            c = [36, 20, 17, 30, 38, 22, 34, 31, 37, 38, 52, 60, 50],
            f = [15, 11, 22, 22, 29, 38, 53, 62, 68, 79, 72, 32, 45];
        ...
        function p(e) {
            var t = arguments.length > 1 && void 0 !== arguments[1] ? arguments[1] : 15,
                ...
                i = 0;
            if (e.length > 0) {
                for (var a = 0; a < e.length; a++) " " != e[a] ? ++r == t && (o.push(a), r = 0) : r = 0;
                if (o.length > 0) {
                    for (var s = 0; s < o.length; s++) n = e.substring(0, o[s] + i) + " " + e.substring(o[s] + i), e = n, i++;
                    return n
                }
                return e
            }
            ...
            var helpers = {
                createLine: function (x1, y1, x2, y2, options) {
                    ...
                    if (isIE) {
                        ...
                        line.style.top = y1 + 0.5 * length * Math.sin(angle) + "%";
                        line.style.left = x1 - 0.5 * length * (1 - Math.cos(angle)) + "%";
        ...
        // Line Drawing Engine End

        $(".rightside").line(c[0] + 5, f[0] + 13, c[1] + 5, f[1] + 11.5, {
            color: "red",
            stroke: 2,
            style: "dashed",
            class: "hidden line"
        });
        $(".rightside").line(c[1] + 5, f[1] + 13, c[2] + 5, f[2] + 11.8, {
            color: "red",
            stroke: 2,
            style: "dashed",
            class: "hidden line"
        });
        $(".rightside").line(c[2] + 5, f[2] + 13, c[3] + 5, f[3] + 12.2, {
            color: "red",
            stroke: 2,
            style: "dashed",
            class: "hidden line"
        });
        $(".rightside").line(c[3] + 5, f[3] + 13, c[4] + 5, f[4] + 11.2, {
            color: "red",
            stroke: 2,
            style: "dashed",
            class: "hidden line"
        });
        $(".rightside").line(c[4] + 5, f[4] + 13, c[5] + 5, f[5] + 9, {
            color: "red",
            stroke: 2,
            style: "dashed",
            class: "hidden line"
        });
        $(".rightside").line(c[5] + 5, f[5] + 13, c[6] + 5, f[6] + 10.2, {
            color: "red",
            stroke: 2,
            style: "dashed",
            class: "hidden line"
        });
        $(".rightside").line(c[6] + 5, f[6] + 13, c[7] + 5, f[7] + 11.5, {
            color: "red",
            stroke: 2,
            style: "dashed",
            class: "hidden line"
        });
        $(".rightside").line(c[7] + 5, f[7] + 13, c[8] + 5, f[8] + 11.1, {
            color: "red",
            stroke: 2,
            style: "dashed",
            class: "hidden line"
        });
        $(".rightside").line(c[8] + 5, f[8] + 13, c[9] + 5, f[9] + 12.5, {
            color: "red",
            stroke: 2,
            style: "dashed",
            class: "hidden line"
        });
        $(".rightside").line(c[9] + 5, f[9] + 13, c[10] + 5, f[10] + 15.7, {
            color: "red",
            stroke: 2,
            style: "dashed",
            class: "hidden line"
        });
        $(".rightside").line(c[10] + 5, f[10] + 10.3, c[11] + 5, f[11] + 15.4, {
            color: "red",
            stroke: 2,
            style: "dashed",
            class: "hidden line"
        });
        $(".rightside").line(c[11] + 5, f[11] + 12, c[12] + 5, f[12] + 11, {
            color: "red",
            stroke: 2,
            style: "dashed",
            class: "hidden line"
        ...
        $(document).ready(function () {
            var e, t, n = document.getElementById("base_url").value + "api/front_data";
            $.ajax({
                url: n,
                method: "get",
                success: function (n) {
                    r = 0 == n.current_distance ? 1 : n.current_distance, o = r, u = n.speed, i = n.latest_tweet.substring(0, 75) + "...", a = n.user_name;
                    if (r == 5505) {
                        $('.flag').attr('src', '/img/final.gif');
                    }

                    for (var d = 1; d < l.length; d++)
                        if (r <= l[d]) {
                            e = c[d - 1] + (r - l[d - 1]) / (l[d] - l[d - 1]) * (c[d] - c[d - 1]), t = f[d - 1] + (r - l[d - 1]) / (l[d] - l[d - 1]) * (f[d] - f[d - 1]), $(".flag").css("top", t + "%"), $(".flag").css("left", e + "%");
                            jQuery(".rightside").line(c[d - 1] + 5, f[d - 1] + 11.5, e + 5, t + 11.5, {
                                color: "red",
                                stroke: 2,
                                style: "dashed",
                                class: "line"
                            ...
                            $(".rightside>div:nth-child(" + (d + 2) + ")").removeClass("hidden");
                        } s = h(o), $(".current_position").text(s), $(".twitter_name").text(p(a, 14)), $(".yellow_text_box p").text(p(i)), $(".current_distance").text(n.current_distance + " كم"), $(".total_distance").text("5505 كم")
                }
                ...
                $.ajax({
                    ...
                    method: "get",
                    success: function (e) {
                        u = e.speed, i = e.latest_tweet.length > 140 ? e.latest_tweet.substring(0, 140) + "..." : e.latest_tweet, a = e.user_name, $(".twitter_name").text(p(a, 14)), $(".yellow_text_box p").text(p(i)), $(".current_distance").text(e.current_distance + " كم"), $(".total_distance").text("5505 كم"), o = e.current_distance, s = h(o), $(".current_position").text(s),
                            function (e) {
                                for (var t, n, o, i, a, s, p, d = [], h = !1, g = 0, v = 1; v < l.length && !h; v++) r >= l[v] || (r >= l[v - 1] && e <= l[v] ? (n = "move_" + $.now(), o = c[v - 1] + (r - l[v - 1]) / (l[v] - l[v - 1]) * (c[v] - c[v - 1]), i = f[v - 1] + (r - l[v - 1]) / (l[v] - l[v - 1]) * (f[v] - f[v - 1]), a = c[v] - (l[v] - e) / (l[v] - l[v - 1]) * (c[v] - c[v - 1]), s = f[v] - (l[v] - e) / (l[v] - l[v - 1]) * (f[v] - f[v - 1]), p = (e - r) / u, $.keyframe.define({
                                    name: n,
                                    from: {
                                        top: i + "%",
                                        left: o + "%"
                                ...
                                }), t = n + " " + p + "s linear " + g + "s 1 forwards", d.push(t), h = !0) : r >= l[v - 1] ? (n = "move_" + $.now() + "_" + v + "_" + (v - 1), o = c[v - 1] + (r - l[v - 1]) / (l[v] - l[v - 1]) * (c[v] - c[v - 1]), i = f[v - 1] + (r - l[v - 1]) / (l[v] - l[v - 1]) * (f[v] - f[v - 1]), a = c[v], s = f[v], p = (l[v] - r) / u, $.keyframe.define({
                                    name: n,
                                    from: {
                                        top: i + "%",
                                        left: o + "%"
                                ...
                                }), t = n + " " + p + "s linear " + g + "s 1 forwards", d.push(t), g += p) : r < l[v - 1] && e > l[v] ? (n = "move" + $.now() + "_" + v + "_" + (v - 1), o = c[v - 1], i = f[v - 1], a = c[v], s = f[v], p = (l[v] - l[v - 1]) / u, $.keyframe.define({
                                    name: n,
                                    from: {
                                        top: i + "%",
                                        left: o + "%"
                                ...
                                }), t = n + " " + p + "s linear " + g + "s 1 forwards", d.push(t), g += p) : e <= l[v] && (n = "move" + $.now() + "_" + v + "_" + (v - 1), o = c[v - 1], i = f[v - 1], a = c[v] - (l[v] - e) / (l[v] - l[v - 1]) * (c[v] - c[v - 1]), s = f[v] - (l[v] - e) / (l[v] - l[v - 1]) * (f[v] - f[v - 1]), p = (e - l[v - 1]) / u, $.keyframe.define({
                                    name: n,
                                    from: {
                                        top: i + "%",
                                        left: o + "%"
                                ...
                                }), t = n + " " + p + "s linear " + g + "s 1 forwards", d.push(t), h = !0));
                                setTimeout(function () {
                                    $(".flag").playKeyframe(d), r = e
                                }, 100)
                            }(o)
                    }
                })
        ...
        var d = ["منطقة الحدود الشمالية", "منطقة الجوف", "منطقة تبوك", "منطقة حائل", "منطقة القصيم", "منطقة المدينة المنورة", "منطقة مكة المكرمة", "منطقة الباحة", "منطقة عسير", "منطقة جيزان", "منطقة نجران", "المنطقة الشرقية", "منطقة الرياض"];

        function h(e) {
            for (var t = 0; t < d.length; t++) {
                if (e == l[0] || 1 == e) return "العلم في " + d[0];
                if (e == l[t]) return "العلم في " + d[t];
                if (e < l[t]) return "العلم متجه إلى  " + d[t];
                if (e > l[12]) return "العلم في " + d[12]
            }
        }
    },
    192: function (e, t) {},
        ...
        ! function (t, n) {
            ...
            C.fn.extend({
                ...
                C.fn[e] = function (n, r) {
                    ...
                    return "Until" !== e.slice(-5) && (r = n), r && "string" == typeof r && (o = C.filter(r, o)), this.length > 1 && (_[e] || C.uniqueSort(o), P.test(e) && o.reverse()), this.pushStack(o)
                }
            });
            var R = /[^\x20\t\r\n\f]+/g;
                    ...
                    var t = [
                        ...
                        o = {
                            ...
                            then: function (e, r, o) {
                                        ...
                                        var s = this,
                                            ...
                                            l = function () {
                                                ...
                                                if (!(e < i)) {
                                                    ...
                                                    l = n && ("object" == typeof n || "function" == typeof n) && n.then, y(l) ? o ? l.call(n, a(i, t, M, o), a(i, t, I, o)) : (i++, l.call(n, a(i, t, M, o), a(i, t, I, o), a(i, t, M, t.notifyWith))) : (r !== M && (s = void 0, u = [n]), (o || t.resolveWith)(s, u))
                                                }
                                            },
                                            c = o ? l : function () {
                                                try {
                                                    ...
                                                    C.Deferred.exceptionHook && C.Deferred.exceptionHook(n, c.stackTrace), e + 1 >= i && (r !== I && (s = void 0, u = [n]), t.rejectWith(s, u))
                                                }
                                            };
                                ...
                                return C.Deferred(function (n) {
                                    t[0][3].add(a(0, n, y(o) ? o : M, n.notifyWith)), t[1][3].add(a(0, n, y(e) ? e : M)), t[2][3].add(a(0, n, y(r) ? r : I))
                                }).promise()
                            },
                            promise: function (e) {
            ...
            function he(e, t) {
                for (var n, r, o = [], i = 0, a = e.length; i < a; i++)(r = e[i]).style && (n = r.style.display, t ? ("none" === n && (o[i] = K.get(r, "display") || null, o[i] || (r.style.display = "")), "" === r.style.display && le(r) && (o[i] = de(r))) : "none" !== n && (o[i] = "none", K.set(r, "display", n)));
            ...
            function Ee(e, t, n, r, o) {
                for (var i, a, s, u, l, c, f = t.createDocumentFragment(), p = [], d = 0, h = e.length; d < h; d++)
                    ...
                    for (a = a || f.appendChild(t.createElement("div")), s = (ve.exec(i) || ["", ""])[1].toLowerCase(), u = ye[s] || ye._default, a.innerHTML = u[1] + C.htmlPrefilter(i) + u[2], c = u[0]; c--;) a = a.lastChild;
                ...
                add: function (e, t, n, r, o) {
                    ...
                    if (v)
                        for (n.handler && (n = (i = n).handler, o = i.selector), o && C.find.matchesSelector(ae, o), n.guid || (n.guid = C.guid++), (u = v.events) || (u = v.events = {}), (a = v.handle) || (a = v.handle = function (t) {
                            ...
                            }), l = (t = (t || "").match(R) || [""]).length; l--;) d = g = (s = je.exec(t[l]) || [])[1], h = (s[2] || "").split(".").sort(), d && (f = C.event.special[d] || {}, d = (o ? f.delegateType : f.bindType) || d, f = C.event.special[d] || {}, c = C.extend({
                            type: d,
                            origType: g,
                            data: r,
                            handler: n,
            ...
            function Be(e, t, n, r) {
                ...
                if (p && (i = (o = Ee(t, e[0].ownerDocument, !1, e, r)).firstChild, 1 === o.childNodes.length && (o = i), i || r)) {
                    for (s = (a = C.map(xe(o, "script"), Re)).length; f < p; f++) u = o, f !== d && (u = C.clone(u, !0, !0), s && C.merge(a, xe(u, "script"))), n.call(e[f], u, f);
                    if (s)
                        for (c = a[a.length - 1].ownerDocument, C.map(a, Me), f = 0; f < s; f++) u = a[f], me.test(u.type || "") && !K.access(u, "globalEval") && C.contains(c, u) && (u.src && "module" !== (u.type || "").toLowerCase() ? C._evalUrl && !u.noModule && C._evalUrl(u.src, {
            ...
            function gt(e, t, n) {
                ...
                for (! function (e, t) {
                    ...
                    if (r = gt.prefilters[i].call(l, e, c, l.opts)) return y(r.stop) && (C._queueHooks(l.elem, l.opts.queue).stop = r.stop.bind(r)), r;
            ...
            C.extend(C.event, {
                trigger: function (e, t, r, o) {
                    ...
                    if (s = d = u = r = r || a, 3 !== r.nodeType && 8 !== r.nodeType && !Et.test(v + C.event.triggered) && (v.indexOf(".") > -1 && (m = v.split("."), v = m.shift(), m.sort()), c = v.indexOf(":") < 0 && "on" + v, (e = e[C.expando] ? e : new C.Event(v, "object" == typeof e && e)).isTrigger = o ? 2 : 3, e.namespace = m.join("."), e.rnamespace = e.namespace ? new RegExp("(^|\\.)" + m.join("\\.(?:.*\\.|)") + "(\\.|$)") : null, e.result = void 0, e.target || (e.target = r), t = null == t ? [e] : C.makeArray(t, [e]), p = C.event.special[v] || {}, o || !p.trigger || !1 !== p.trigger.apply(r, t))) {
                        if (!o && !p.noBubble && !x(r)) {
                            for (l = p.delegateType || v, Et.test(l + v) || (s = s.parentNode); s; s = s.parentNode) g.push(s), u = s;
                            u === (r.ownerDocument || a) && g.push(u.defaultView || u.parentWindow || n)
                        }
                        for (i = 0;
                            (s = g[i++]) && !e.isPropagationStopped();) d = s, e.type = i > 1 ? l : p.bindType || v, (f = (K.get(s, "events") || {})[e.type] && K.get(s, "handle")) && f.apply(s, t), (f = c && s[c]) && f.apply && Q(s) && (e.result = f.apply(s, t), !1 === e.result && e.preventDefault());
                        return e.type = v, o || e.isDefaultPrevented() || p._default && !1 !== p._default.apply(g.pop(), t) || !Q(r) || c && y(r[v]) && !x(r) && ((u = r[c]) && (r[c] = null), C.event.triggered = v, e.isPropagationStopped() && d.addEventListener(v, kt), r[v](), e.isPropagationStopped() && d.removeEventListener(v, kt), C.event.triggered = void 0, u && (r[c] = u)), e.result
                    }
                },
            ...
            function Ht(e, t, n, r) {
                ...
                if (Array.isArray(t)) C.each(t, function (t, o) {
                    n || At.test(e) ? r(e, o) : Ht(e + "[" + ("object" == typeof o && null != o ? t : "") + "]", o, n, r)
                });
            ...
            Ft.href = St.href, C.extend({
                ...
                ajax: function (e, t) {
                    ...
                    var r, o, i, s, u, l, c, f, p, d, h = C.ajaxSetup({}, t),
                        g = h.context || h,
                        ...
                        E = {
                            ...
                            getResponseHeader: function (e) {
                                ...
                                if (c) {
                                    if (!s)
                                        for (s = {}; t = $t.exec(i);) s[t[1].toLowerCase() + " "] = (s[t[1].toLowerCase() + " "] || []).concat(t[2]);
                                    t = s[e.toLowerCase() + " "]
                                }
                    ...
                    if (m.promise(E), h.url = ((e || h.url || St.href) + "").replace(Mt, St.protocol + "//"), h.type = t.method || t.type || h.method || h.type, h.dataTypes = (h.dataType || "*").toLowerCase().match(R) || [""], null == h.crossDomain) {
                        l = a.createElement("a");
                        try {
                    ...
                    if (h.data && h.processData && "string" != typeof h.data && (h.data = C.param(h.data, h.traditional)), Ut(It, h, t, E), c) return E;
                    for (p in (f = C.event && h.global) && 0 == C.active++ && C.event.trigger("ajaxStart"), h.type = h.type.toUpperCase(), h.hasContent = !Rt.test(h.type), o = h.url.replace(Pt, ""), h.hasContent ? h.data && h.processData && 0 === (h.contentType || "").indexOf("application/x-www-form-urlencoded") && (h.data = h.data.replace(Ot, "+")) : (d = h.url.slice(o.length), h.data && (h.processData || "string" == typeof h.data) && (o += (Nt.test(o) ? "&" : "?") + h.data, delete h.data), !1 === h.cache && (o = o.replace(_t, "$1"), d = (Nt.test(o) ? "&" : "?") + "_=" + jt++ + d), h.url = o + d), h.ifModified && (C.lastModified[o] && E.setRequestHeader("If-Modified-Since", C.lastModified[o]), C.etag[o] && E.setRequestHeader("If-None-Match", C.etag[o])), (h.data && h.hasContent && !1 !== h.contentType || t.contentType) && E.setRequestHeader("Content-Type", h.contentType), E.setRequestHeader("Accept", h.dataTypes[0] && h.accepts[h.dataTypes[0]] ? h.accepts[h.dataTypes[0]] + ("*" !== h.dataTypes[0] ? ", " + Bt + "; q=0.01" : "") : h.accepts["*"]), h.headers) E.setRequestHeader(p, h.headers[p]);
                    if (h.beforeSend && (!1 === h.beforeSend.call(g, E, h) || c)) return E.abort();
                    if (T = "abort", y.add(h.complete), E.done(h.success), E.fail(h.error), r = Ut(Wt, h, t, E)) {
            ...
            C.ajaxSetup({
                ...
                if (s || "jsonp" === e.dataTypes[0]) return o = e.jsonpCallback = y(e.jsonpCallback) ? e.jsonpCallback() : e.jsonpCallback, s ? e[s] = e[s].replace(Jt, "$1" + o) : !1 !== e.jsonp && (e.url += (Nt.test(e.url) ? "&" : "?") + e.jsonp + "=" + o), e.converters["script json"] = function () {
                    return a || C.error(o + " was not called"), a[0]
                }, e.dataTypes[0] = "json", i = n[o], n[o] = function () {
                    a = arguments
                }, r.always(function () {
                    void 0 === i ? C(n).removeProp(o) : n[o] = i, e[o] && (e.jsonpCallback = t.jsonpCallback, Qt.push(o)), a && y(i) && i(a[0]), a = i = void 0
                }), "script"
                ...
                return "string" != typeof e ? [] : ("boolean" == typeof t && (n = t, t = !1), t || (m.createHTMLDocument ? ((r = (t = a.implementation.createHTMLDocument("")).createElement("base")).href = a.location.href, t.head.appendChild(r)) : t = a), i = !n && [], (o = L.exec(e)) ? [t.createElement(o[1])] : (o = Ee([e], t, i), i && i.length && C(i).remove(), C.merge([], o.childNodes)));
                var r, o, i
